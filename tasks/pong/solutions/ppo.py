...
from tasks.pong.utils import preprocess_batch
...
if __name__ == "__main__":
    ...
    policy = PPOPolicy(
        epsilon_scheduler=ParameterScheduler(initial=INITIAL_EPSILON, lambda_fn=lambda i: INITIAL_EPSILON*EPSILON_DECAY_GAMMA**i, final=FINAL_EPSILON),
    ...
    agent.save(os.path.join(dirname, 'ppo_agent.pt'))
