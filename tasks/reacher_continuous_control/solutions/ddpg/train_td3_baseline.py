...
from agents.models.components.noise import OUNoise, GaussianNoise
...
if __name__ == "__main__":
    ...
    simulator.warmup(agents, n_episodes=int(WARMUP_STEPS / MAX_T), max_t=MAX_T)
    ...
    if training_scores.get_mean_sliding_scores() > SOLVE_SCORE:
        torch.save(DDPGAgent.online_actor.state_dict(), ACTOR_CHECKPOINT_PATH)
        torch.save(DDPGAgent.online_critic.state_dict(), CRITIC_CHECKPOINT_PATH)
